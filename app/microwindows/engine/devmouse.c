...
static MWCOORD	xpos=0;		/* current x position of mouse */
static MWCOORD	ypos=0;		/* current y position of mouse */
static MWCOORD	minx=0;		/* minimum allowed x position */
static MWCOORD	maxx=0;		/* maximum allowed x position */
static MWCOORD	miny=0;		/* minimum allowed y position */
static MWCOORD	maxy=0;		/* maximum allowed y position */
static int	scale=0;		/* acceleration scale factor */
static int	thresh=0;		/* acceleration threshhold */
static int	buttons=0;	/* current state of buttons */
static MWBOOL	changed=0;	/* mouse state has changed */

static MWCOORD 	curminx=0;	/* minimum x value of cursor */
static MWCOORD 	curminy=0;	/* minimum y value of cursor */
static MWCOORD 	curmaxx=0;	/* maximum x value of cursor */
static MWCOORD 	curmaxy=0;	/* maximum y value of cursor */
static int	curvisible=0;	/* >0 if cursor is visible*/
static MWBOOL 	curneedsrestore=0;/* cursor needs restoration after drawing*/
static MWCOORD 	cursavx=0;	/* saved cursor location*/
static MWCOORD 	cursavy=0;
static MWCOORD	cursavx2=0;
static MWCOORD	cursavy2=0;
static MWPIXELVAL curfg=0;		/* foreground color of cursor */
static MWPIXELVAL curbg=0;		/* background color of cursor */
