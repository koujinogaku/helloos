 ...
 */
MWCOORD clipminx=0;		/* minimum x value of cache rectangle */
MWCOORD clipminy=0;		/* minimum y value of cache rectangle */
MWCOORD clipmaxx=0;		/* maximum x value of cache rectangle */
MWCOORD clipmaxy=0;		/* maximum y value of cache rectangle */

static MWBOOL	clipresult=0;	/* whether clip rectangle is plottable */
int 	clipcount=0;		/* number of clip rectangles */
